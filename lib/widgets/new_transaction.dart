...
class _NewTransactionFormState extends State<NewTransactionForm> {
  ...
  _NewTransactionFormState() {
    _autoValidateToggle = AutovalidateMode.disabled;
  ...
  void _onSubmit() {
    if (_formKey.currentState!.validate()) {
      ...
      _autoValidateToggle = AutovalidateMode.always;
    }
  }
...
class RaisedButton {
  static icon({required Icon icon, required RoundedRectangleBorder shape, required Text label, required Color textColor, Color? color, required void Function() onPressed}) {}
}